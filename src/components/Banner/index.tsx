    ...
    <section className="flex flex-col p-4 text-right md:px-6 md:py-2">
      ...
      <div className="flex w-full justify-end text-right">
        <Tooltip
          content={<WeChatImage />}
          direction="right"
          styling="from-theme-300 to-theme-300 p-2 text-white"
        >
          <a href="#" className="ml-8 w-7 py-12">
            <svg
              className="fill-theme-400 hover:fill-theme-300"
        ...
        <a href="mailto:damonmaozewu@gmail.com" className="ml-8 w-6 py-12">
          <svg
            className="fill-theme-500 hover:fill-theme-600"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
          >
        ...
        <a href="https://github.com/DamengRandom" className="ml-8 w-6 py-12">
          <svg
            className="fill-theme-200 hover:fill-theme-100"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 496 512"
          >
